...
import static interfaceGraphique.weightedCanvas.graph;
import static interfaceGraphique.weightedCanvas.undirected;
...
public class Canvas extends javax.swing.JPanel {
     ...
     */
    public static UnweightedGraph gr;
    ...
    public Canvas() {
        ...
        System.out.println("canvas: "+undirected);
    }
    public void  initialisation(boolean type ){           
         gr= new UnweightedGraph(type);
         graph = new Graph();
    }
        ...
        // TODO add your handling code here:
         for (Node node : graph.getNodes()) {
            if(selectedNode !=null && node!= selectedNode && Draw.isWithinBounds(evt, node.getCoord())){
                ...
                gr.addEdge(selectedNode.getId(), node.getId());
                graph.setSolved(false);
            }
        }
        selectedNode = null;
